 ...
 * StudentTopHeader
 *
 * Horizontal top bar that sits above all student pages.
 ...
 *   signOutLabel — translated "Sign out" label from i18n
 */
export default function StudentTopHeader({ user, logout, signOutLabel = 'Sign out' }) {
